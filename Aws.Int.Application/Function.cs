...
using System.Net;
using Aws.Int.Application.Extensions;
using Aws.Int.Application.Application.MediatR.Commands.SecretManager;
using Aws.Int.Application.Application.MediatR.Commands.Sns;

[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.Json.JsonSerializer))]
namespace Aws.Int.Application
{
    public class Function
    {
        ...
        public APIGatewayProxyResponse SendSns(APIGatewayProxyRequest request, ILambdaContext lambdaContext)
        {
            lambdaContext.Logger.LogLine($"Body {request.Body}");

            return Request<SnsCommand>(request.Body);
        }

        public APIGatewayProxyResponse GetSecret(APIGatewayProxyRequest request, ILambdaContext lambdaContext)
        {
            lambdaContext.Logger.LogLine($"Body {request.Body}");

            return Request<SecretManagerCommand>(request.Body);
        }
